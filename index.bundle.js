...
_log__WEBPACK_IMPORTED_MODULE_2__.initialTasks.localStorageInsert();
  ...
  function localStorageInsert(title, taskTitle) {
    if (isLocalStorageAvailable()) {
      ...
      if (localStorage.getItem("lists") === null) {
        ...
        sidebar.innerHTML = '';
        renderLists();
        _page__WEBPACK_IMPORTED_MODULE_0__.initialRender.renderAddList();
      }
...
const homePage = () => {
  ...
  function renderPlus() {
    ...
    plusBtn.addEventListener('click', function(event) {
      ...
      _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.localStorageInsert();
    });
  }
  ...
  function renderMainTitle(title) {
    ...
    function deleteProject(projectTitle) {
      ...
      for (let i = 0; i < _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects.length; i++) {
        ...
        if (_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects[i].title == projectTitle) {
          ...
          localStorage.setItem("projects", JSON.stringify(_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects));
        }
      }; 
    ...
    deleteProjectBtn.addEventListener('click', function(event) {
      event.stopPropagation();
      _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects = JSON.parse(localStorage.getItem("projects"));
      deleteProject(title);
  ...
  function displayLists(title) {
    ...
    function deleteList(listTitle) {
      ...
      for (let i = 0; i < _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myLists.length; i++) {
        ...
        if (_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myLists[i].title == title) {
          ...
          localStorage.setItem("lists", JSON.stringify(_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myLists));
        }
      }
    ...
    deleteListBtn.addEventListener('click', function(event) {
      ...
      _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myLists = JSON.parse(localStorage.getItem("lists"));
      deleteList(title);
      main.innerHTML = '';
      header.innerHTML = '';
      renderLogo();
  ...
  function displayProject(container, title, parentTitle) {
    ...
    projectBtn.addEventListener('click', function(event) {
      ...
      _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.localStorageInsert(title);
    });
  ...
  function displayTask(container, title, parentTitle, task) {
    ...
    function deleteToDo(toDoDeleteTarget) {
      ...
      localStorage.setItem("todos", JSON.stringify(_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myToDos));
    }
    ...
    checkbox.addEventListener("click", function () {
      if (checkbox.value == 'on') {
        _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myToDos = JSON.parse(localStorage.getItem("todos"));
        _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myTasks = JSON.parse(localStorage.getItem("tasks"));
        _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects = JSON.parse(localStorage.getItem("projects"));
        _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myLists = JSON.parse(localStorage.getItem("lists"));
        deleteToDo(task);
        let taskHolder;
        let projectHolder;
        for (let i = 0; i < _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myTasks.length; i++) {
          if (_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myTasks[i].title == task.parentTitle) {
            taskHolder = _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myTasks[i];
          }
        }
        if (taskHolder != null && taskHolder != undefined) {
          for (let j = 0; j < _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects.length; j++) {
            if (_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects[j].title == taskHolder.parentTitle) {
              projectHolder = _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects[j];
            }
          }
          localStorage.setItem("lists", JSON.stringify(_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myLists));
        }
        _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.localStorageInsert(projectHolder.title, taskHolder.title);
      }
    });
    ...
    toDoBtn.addEventListener('click', function(event) {
      ...
      saveDescriptionBtn.addEventListener('click', function(event) {
        ...
        for (let i = 0; i < _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myToDos.length; i++) {
          if (_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myToDos[i].title == toDo.title) {
            _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myToDos[i].description = toDo.description;
            _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myToDos[i].priority = toDo.priority;
            _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myToDos[i].dueDate = toDo.dueDate;
          }
        }
        localStorage.setItem("todos", JSON.stringify(_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myToDos));
      });
      ...
      if (toDoHolderThree != null && toDoHolderThree != undefined) {
        ...
        for (let j = 0; j < _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myTasks.length; j++) {
          if (_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myTasks[j].title == toDoHolderThree.parentTitle) {
            taskHolderThree = _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myTasks[j];
          }
        }
        for (let k = 0; k < _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects.length; k++) {
          if (_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects[k].title == taskHolderThree.parentTitle) {
            projectHolderThree = _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects[k];
          }
        }
      }
      // initialTasks.localStorageInsert(projectHolderThree.title);
      box.insertBefore(container, subContainer.nextSibling);
    });
  }
  ...
  function renderSubDropdown(box, title) {
    ...
    toDoBtn.addEventListener('click', function(event) {
      event.stopPropagation();
      let newToDo = _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.addToDo(prompt('New Todo:'), title);
      ...
      for (let m = 0; m < _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myTasks.length; m++) {
        if (_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myTasks[m].title == title) {
          taskHolderTwo = _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myTasks[m];
        }
      }
      if (taskHolderTwo != null && taskHolderTwo != undefined) {
        for (let p = 0; p < _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects.length; p++) {
          if (_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects[p].title == taskHolderTwo.parentTitle) {
            projectHolderTwo = _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects[p];
          }
        }
        // localStorage.setItem("lists", JSON.stringify(initialTasks.myLists));
      }
      _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.localStorageInsert(projectHolderTwo.title, taskHolderTwo.title);
    });
    ...
    function deleteSection(sectionTitle) {
      for (let i = 0; i < _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myToDos.length; i++) {
        _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myToDos[i].toDoIndex = i;
        _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myToDos[i].toDoId = i.toString();
      }
      for (let i = 0; i < _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myToDos.length; i++) {
      ...
      for (let k = 0; k < _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myTasks.length; k++) {
        ...
        if (_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myTasks[k].title == sectionTitle) {
          ...
          localStorage.setItem("tasks", JSON.stringify(_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myTasks));
        }
      }; 
    }
    ...
    deleteTaskBtn.addEventListener('click', function(event) {
      ...
      for (let n = 0; n < _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myTasks.length; n++) {
        if (_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myTasks[n].title == title) {
          holderParentTitle = _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myTasks[n].parentTitle;
        }
      }
      deleteSection(title);
      let mainBoxSelect = document.querySelector('#cardBox');
      ...
      _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.renderTasks(title);
      _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.localStorageInsert(holderParentTitle);
    });
  }
