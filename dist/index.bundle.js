...
main #mainTitle #delete-project-btn {
  display: flex;
  align-items: center;
  padding: 0.8rem 1rem;
  text-decoration: none;
...
.projectContainer {
  ...
  flex-direction: column;
  align-items: flex-start;
}`, "",{"version":3,"sources":["webpack://./src/css/main.css"],"names":[],"mappings":"AAAA,gBAAgB;AAChB;;;;;;;;;;;;;EAaE,SAAS;EACT,UAAU;EACV,SAAS;EACT,eAAe;EACf,aAAa;EACb,wBAAwB;AAC1B;;AAEA,gDAAgD;AAChD;;EAEE,cAAc;AAChB;;AAEA;EACE,cAAc;AAChB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,YAAY;AACd;;AAEA;;EAEE,WAAW;EACX,aAAa;AACf;;AAEA;EACE,yBAAyB;EACzB,iBAAiB;AACnB;;AAEA;EACE,sBAAsB;AACxB;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,cAAc;EACd,eAAe;AACjB;;AAEA;EACE,kIAAkI;AACpI;;AAEA;EACE,aAAa;EACb,YAAY;EACZ,SAAS;EACT,qBAAqB;EACrB,mBAAmB;EACnB,yBAAyB;EACzB,eAAe;EACf,kBAAkB;AACpB;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,yCAAyC;EACzC,aAAa;EACb,eAAe;AACjB;;AAEA;EACE,yBAAyB;EACzB,YAAY;EACZ,aAAa;EACb,aAAa;EACb,mBAAmB;EACnB,yCAAyC;EACzC,aAAa;AACf;AACA;EACE,YAAY;EACZ,WAAW;EACX,iBAAiB;EACjB,mBAAmB;EACnB,kBAAkB;AACpB;AACA;EACE,YAAY;EACZ,WAAW;EACX,iBAAiB;EACjB,mBAAmB;EACnB,sBAAsB;EACtB,iBAAiB;AACnB;AACA;EACE,YAAY;EACZ,WAAW;EACX,iBAAiB;EACjB,mBAAmB;EACnB,sBAAsB;EACtB,iBAAiB;AACnB;;AAEA;EACE,UAAU;AACZ;;AAEA;EACE,cAAc;EACd,UAAU;EACV,SAAS;EACT,aAAa;EACb,sBAAsB;EACtB,2BAA2B;EAC3B,mBAAmB;EACnB,aAAa;EACb,SAAS;EACT,yBAAyB;AAC3B;AACA;EACE,aAAa;EACb,QAAQ;EACR,kBAAkB;EAClB,mBAAmB;AACrB;AACA;EACE,aAAa;EACb,mBAAmB;EACnB,oBAAoB;EACpB,qBAAqB;EACrB,YAAY;EACZ,kBAAkB;EAClB,kBAAkB;EAClB,YAAY;EACZ,YAAY;EACZ,yBAAyB;EACzB,uBAAuB;EACvB,UAAU;AACZ;AACA;EACE,yBAAyB;EACzB,UAAU;EACV,sBAAsB;AACxB;AACA;EACE,aAAa;EACb,uBAAuB;EACvB,YAAY;EACZ,WAAW;EACX,UAAU;AACZ;AACA;EACE,gBAAgB;AAClB;AACA;EACE,gBAAgB;EAChB,mBAAmB;EACnB,yBAAyB;EACzB,iBAAiB;AACnB;AACA;EACE,aAAa;EACb,mBAAmB;AACrB;AACA;EACE,YAAY;EACZ,WAAW;EACX,iBAAiB;EACjB,iBAAiB;AACnB;AACA;EACE,aAAa;EACb,cAAc;AAChB;AACA;EACE,aAAa;EACb,QAAQ;EACR,mBAAmB;AACrB;;AAEA;EACE,cAAc;EACd,UAAU;EACV,yBAAyB;EACzB,SAAS;EACT,aAAa;EACb,aAAa;EACb,sBAAsB;EACtB,mBAAmB;AACrB;AACA;EACE,YAAY;EACZ,WAAW;EACX,iBAAiB;EACjB,mBAAmB;EACnB,sBAAsB;EACtB,iBAAiB;AACnB;AACA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,kBAAkB;EAClB,8BAA8B;EAC9B,WAAW;EACX,mBAAmB;AACrB;AACA;EACE,aAAa;EACb,uBAAuB;EACvB,YAAY;EACZ,WAAW;EACX,UAAU;AACZ;AACA;EACE,aAAa;EACb,mBAAmB;EACnB,oBAAoB;EACpB,qBAAqB;EACrB,YAAY;EACZ,kBAAkB;EAClB,kBAAkB;EAClB,YAAY;EACZ,YAAY;EACZ,yBAAyB;AAC3B;AACA;EACE,kBAAkB;AACpB;;AAEA;EACE,kBAAkB;EAClB,WAAW;EACX,YAAY;EACZ,yBAAyB;EACzB,4BAA4B;EAC5B,kBAAkB;EAClB,mBAAmB;EACnB,kBAAkB;EAClB,UAAU;EACV,6BAA6B;EAC7B,kDAAkD;EAClD,aAAa;EACb,sBAAsB;EACtB,QAAQ;AACV;AACA;EACE,aAAa;EACb,mBAAmB;EACnB,2BAA2B;OACtB,sBAAsB;EAC3B,oBAAoB;EACpB,qBAAqB;EACrB,YAAY;EACZ,kBAAkB;EAClB,kBAAkB;EAClB,YAAY;EACZ,YAAY;AACd;AACA;EACE,yBAAyB;AAC3B;AACA;EACE,aAAa;EACb,YAAY;EACZ,cAAc;EACd,WAAW;EACX,aAAa;EACb,wCAAwC;EACxC,2BAA2B;EAC3B,kBAAkB;AACpB;AACA;EACE,yBAAyB;EACzB,YAAY;EACZ,gBAAgB;EAChB,uBAAuB;EACvB,cAAc;EACd,gBAAgB;AAClB;AACA;EACE,yBAAyB;EACzB,YAAY;EACZ,gBAAgB;EAChB,uBAAuB;EACvB,cAAc;EACd,eAAe;AACjB;;AAEA;EACE,UAAU;AACZ;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,YAAY;EACZ,WAAW;EACX,UAAU;AACZ;;AAEA;EACE,WAAW;EACX,kBAAkB;EAClB,QAAQ;EACR,aAAa;EACb,mBAAmB;EACnB,QAAQ;EACR,mBAAmB;AACrB;AACA;EACE,yBAAyB;EACzB,iBAAiB;EACjB,aAAa;EACb,uBAAuB;AACzB;AACA;EACE,aAAa;AACf;;AAEA;EACE,YAAY;EACZ,WAAW;EACX,yDAA+C;EAC/C,4BAA4B;AAC9B;;AAEA;EACE,kBAAkB;EAClB,WAAW;AACb;;AAEA;EACE,mBAAmB;EACnB,UAAU;EACV,2BAA2B;EAC3B,aAAa;EACb,sBAAsB;AACxB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,2BAA2B;EAC3B,uBAAuB;EACvB,SAAS;EACT,aAAa;EACb,cAAc;EACd,YAAY;EACZ,WAAW;EACX,sBAAsB;AACxB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,8BAA8B;EAC9B,mBAAmB;EACnB,aAAa;EACb,YAAY;EACZ,yBAAyB;EACzB,aAAa;EACb,kBAAkB;EAClB,kCAAkC;AACpC;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,QAAQ;EACR,WAAW;EACX,yBAAyB;AAC3B;AACA;EACE,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,WAAW;EACX,yBAAyB;AAC3B;AACA;EACE,yBAAyB;EACzB,eAAe;AACjB;AACA;EACE,yBAAyB;AAC3B;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,kCAAkC;AACpC;AACA;EACE,cAAc;EACd,aAAa;AACf;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,cAAc;AAChB;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,kBAAkB;EAClB,2BAA2B;EAC3B,qBAAqB;EACrB,eAAe;EACf,SAAS;EACT,wBAAwB;KACrB,qBAAqB;UAChB,gBAAgB;AAC1B;;AAEA;EACE,oCAAoC;AACtC;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,qBAAqB;EACrB,kBAAkB;EAClB,YAAY;EACZ,SAAS;EACT,SAAS;EACT,iBAAiB;EACjB,cAAc;AAChB;;AAEA;EACE,sBAAsB;AACxB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,kBAAkB;EAClB,2BAA2B;AAC7B;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,uBAAuB;AACzB","sourcesContent":["@charset \"UTF-8\";\nhtml, body, div, span, applet, object, iframe,\nh1, h2, h3, h4, h5, h6, p, blockquote, pre,\na, abbr, acronym, address, big, cite, code,\ndel, dfn, em, img, ins, kbd, q, s, samp,\nsmall, strike, strong, sub, sup, tt, var,\nb, u, i, center,\ndl, dt, dd, ol, ul, li,\nfieldset, form, label, legend,\ntable, caption, tbody, tfoot, thead, tr, th, td,\narticle, aside, canvas, details, embed,\nfigure, figcaption, footer, header, hgroup,\nmenu, nav, output, ruby, section, summary,\ntime, mark, audio, video {\n  margin: 0;\n  padding: 0;\n  border: 0;\n  font-size: 100%;\n  font: inherit;\n  vertical-align: baseline;\n}\n\n/* HTML5 display-role reset for older browsers */\narticle, aside, details, figcaption, figure,\nfooter, header, hgroup, menu, nav, section {\n  display: block;\n}\n\nbody {\n  line-height: 1;\n}\n\nol, ul {\n  list-style: none;\n}\n\nblockquote, q {\n  quotes: none;\n}\n\nblockquote:before, blockquote:after,\nq:before, q:after {\n  content: \"\";\n  content: none;\n}\n\ntable {\n  border-collapse: collapse;\n  border-spacing: 0;\n}\n\n*, *::before, *::after {\n  box-sizing: border-box;\n}\n\nbody {\n  min-height: 100vh;\n}\n\nimg, picture, svg, video {\n  display: block;\n  max-width: 100%;\n}\n\n:root {\n  --system-ui: system-ui, \"Segoe UI\", Roboto, Helvetica, Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\";\n}\n\nbutton {\n  display: flex;\n  border: none;\n  margin: 0;\n  text-decoration: none;\n  align-items: center;\n  background-color: #059669;\n  cursor: pointer;\n  text-align: center;\n}\n\nh1, h2, h3, h4, h5 {\n  font-weight: bolder;\n}\n\nbody {\n  font-family: Arial, Helvetica, sans-serif;\n  display: flex;\n  flex-wrap: wrap;\n}\n\nheader {\n  background-color: #059669;\n  width: 100vw;\n  height: 7.5vh;\n  display: flex;\n  align-items: center;\n  box-shadow: inset -4px -4px 20px 0px gray;\n  padding: 12px;\n}\nheader > img {\n  height: 50px;\n  width: 50px;\n  aspect-ratio: 1/1;\n  border-radius: 16px;\n  margin-right: auto;\n}\nheader #plusTask {\n  height: 25px;\n  width: 25px;\n  aspect-ratio: 1/1;\n  border-radius: 16px;\n  background-color: gold;\n  margin-right: 4px;\n}\nheader #plusSub {\n  height: 25px;\n  width: 25px;\n  aspect-ratio: 1/1;\n  border-radius: 16px;\n  background-color: gold;\n  margin-right: 4px;\n}\n\n#dropdownList {\n  left: 44px;\n}\n\n#sidebar {\n  height: 92.5vh;\n  width: 20%;\n  margin: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n  align-items: center;\n  padding: 16px;\n  gap: 12px;\n  background-color: #f3f4f6;\n}\n#sidebar > div {\n  display: flex;\n  gap: 4px;\n  margin-right: auto;\n  align-items: center;\n}\n#sidebar > div #delete-list-btn {\n  display: flex;\n  align-items: center;\n  padding: 0.8rem 1rem;\n  text-decoration: none;\n  color: black;\n  border-radius: 8px;\n  font-size: 0.75rem;\n  width: 115px;\n  height: 50px;\n  background-color: #059669;\n  justify-content: center;\n  top: -40px;\n}\n#sidebar > div > button {\n  background-color: #f3f4f6;\n  padding: 0;\n  align-self: flex-start;\n}\n#sidebar > div > div > button {\n  display: flex;\n  background: transparent;\n  height: 24px;\n  width: 24px;\n  padding: 0;\n}\n#sidebar .projectSection {\n  margin-top: 16px;\n}\n#sidebar #newList {\n  margin-top: auto;\n  align-items: center;\n  background-color: #f3f4f6;\n  margin-left: auto;\n}\n#sidebar #newList > div {\n  display: flex;\n  align-items: center;\n}\n#sidebar #newList > div #plusList {\n  height: 25px;\n  width: 25px;\n  aspect-ratio: 1/1;\n  margin-right: 4px;\n}\n#sidebar img {\n  width: 1.5rem;\n  height: 1.5rem;\n}\n#sidebar .project {\n  display: flex;\n  gap: 4px;\n  align-items: center;\n}\n\nmain {\n  height: 92.5vh;\n  width: 80%;\n  background-color: #f8fafc;\n  margin: 0;\n  padding: 24px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\nmain #plusToDo {\n  height: 25px;\n  width: 25px;\n  aspect-ratio: 1/1;\n  border-radius: 16px;\n  background-color: gold;\n  margin-right: 4px;\n}\nmain #mainTitle {\n  display: flex;\n  align-self: flex-start;\n  flex-direction: row;\n  padding-left: 24px;\n  justify-content: space-between;\n  width: 100%;\n  align-items: center;\n}\nmain #mainTitle button {\n  display: flex;\n  background: transparent;\n  height: 24px;\n  width: 24px;\n  padding: 0;\n}\nmain #mainTitle #delete-project-btn {\n  display: flex;\n  align-items: center;\n  padding: 0.8rem 1rem;\n  text-decoration: none;\n  color: black;\n  border-radius: 8px;\n  font-size: 0.75rem;\n  width: 115px;\n  height: 50px;\n  background-color: #059669;\n}\nmain #mainTitle > div {\n  margin-right: 24px;\n}\n\n.dropdown {\n  position: absolute;\n  right: 44px;\n  width: 120px;\n  box-shadow: var(--shadow);\n  border-radius: var(--radius);\n  margin-top: 0.3rem;\n  background: #f8fafc;\n  visibility: hidden;\n  opacity: 0;\n  transform: translateY(0.5rem);\n  transition: all 0.1s cubic-bezier(0.16, 1, 0.5, 1);\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n}\n.dropdown button {\n  display: flex;\n  align-items: center;\n  -moz-column-gap: var(--gap);\n       column-gap: var(--gap);\n  padding: 0.8rem 1rem;\n  text-decoration: none;\n  color: black;\n  border-radius: 8px;\n  font-size: 0.75rem;\n  width: 115px;\n  height: 50px;\n}\n.dropdown button:hover {\n  background-color: #f3f4f6;\n}\n.dropdown textarea {\n  outline: none;\n  resize: none;\n  overflow: auto;\n  width: 100%;\n  height: 100px;\n  box-shadow: inset -1px -1px 7px 0px gray;\n  border: 1px solid lightgray;\n  border-radius: 8px;\n}\n.dropdown #dueDateInput {\n  background-color: #f8fafc;\n  width: 100px;\n  border-radius: 0;\n  border: 1px solid black;\n  height: 1.5rem;\n  min-width: 105px;\n}\n.dropdown #priorityInput {\n  background-color: #f8fafc;\n  width: 100px;\n  border-radius: 0;\n  border: 1px solid black;\n  height: 1.5rem;\n  min-width: 25px;\n}\n\n#dropdown {\n  z-index: 2;\n}\n\n#dropdownBtn {\n  display: flex;\n  background: transparent;\n  height: 24px;\n  width: 24px;\n  padding: 0;\n}\n\n#dropdownToDo {\n  width: 100%;\n  position: relative;\n  right: 0;\n  display: flex;\n  align-items: center;\n  gap: 4px;\n  flex-direction: row;\n}\n#dropdownToDo button {\n  background-color: #059669;\n  padding: 8px 10px;\n  display: flex;\n  justify-content: center;\n}\n#dropdownToDo h2 {\n  display: flex;\n}\n\n.container {\n  height: 24px;\n  width: 24px;\n  background-image: url(\"../dots-horizontal.svg\");\n  background-repeat: no-repeat;\n}\n\n.containerToDoDropdown {\n  position: relative;\n  width: 100%;\n}\n\n.show {\n  visibility: visible;\n  opacity: 1;\n  transform: translateY(0rem);\n  display: flex;\n  flex-direction: column;\n}\n\n#cardBox {\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n  align-items: flex-start;\n  gap: 12px;\n  padding: 24px;\n  overflow: auto;\n  height: 100%;\n  width: 100%;\n  align-self: flex-start;\n}\n\n.card {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  align-items: center;\n  height: 250px;\n  width: 300px;\n  background-color: #e2e8f0;\n  padding: 24px;\n  border-radius: 8px;\n  box-shadow: 6px 7px 10px -5px gray;\n}\n\n.subContainer {\n  display: flex;\n  flex-direction: column;\n  gap: 6px;\n  width: 100%;\n  background-color: #f8fafc;\n}\n.subContainer > .taskContainer {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n  width: 100%;\n  background-color: #f8fafc;\n}\n.subContainer > .taskContainer label {\n  background-color: #f8fafc;\n  font-size: 1rem;\n}\n.subContainer > .taskContainer button {\n  background-color: #f8fafc;\n}\n\n.titleContainer {\n  display: flex;\n  justify-content: space-between;\n  border-bottom: 1px solid lightgray;\n}\n.titleContainer img {\n  height: 1.5rem;\n  width: 1.5rem;\n}\n\nh1 {\n  font-size: 2rem;\n}\n\nh3 {\n  color: #0069ed;\n}\n\ninput {\n  width: 24px;\n  height: 24px;\n  border-radius: 8px;\n  transition: box-shadow 0.3s;\n  background: lightgrey;\n  cursor: pointer;\n  border: 0;\n  -webkit-appearance: none;\n     -moz-appearance: none;\n          appearance: none;\n}\n\ninput:checked {\n  box-shadow: inset 0 0 0 20px #0069ed;\n}\n\ninput:not(:checked)::before {\n  display: none;\n}\n\ninput:checked::before {\n  display: inline-block;\n  position: relative;\n  content: \"✓\";\n  top: -1px;\n  left: 3px;\n  font-size: 1.5rem;\n  color: #f3f4f6;\n}\n\ninput:hover {\n  background-color: #ccc;\n}\n\nlabel {\n  cursor: pointer;\n}\n\n.taskContainer {\n  display: flex;\n  align-items: center;\n  width: -moz-max-content;\n  width: max-content;\n  justify-content: flex-start;\n}\n\n.projectContainer {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n}"],"sourceRoot":""}]);
// Exports
...
const homePage = () => {
  ...
  function renderMainTitle(title) {
    ...
    function deleteProject(projectTitle) {
      ...
      _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myTasks.forEach((task) => {
        if (task.parentTitle == projectTitle) {
          renderSubDropdown.deleteSection(task.title);
        }
      });

      for (let i = 0; i < _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects.length; i++) {

        if (_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects[i].title == projectTitle) {
          _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects.splice(i, 1);
        }
      }; 
  ...
  function displayLists(title) {
    ...
    function deleteList(listTitle) {
      ...
      _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects.forEach((project) => {
        if (project.parentTitle == listTitle) {
          renderMainTitle.deleteProject(project.title);
        }
      });

      for (let i = 0; i < _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myLists.length; i++) {

        if (_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myLists[i].title == title) {
          _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myLists.splice(i, 1);
        }
      }; 

      const listContainerSelect = document.querySelector(`#${title.replace(/\s+/g, '-').toLowerCase()}`);
      listContainerSelect.innerHTML = '';
      console.log(_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myLists);
      console.log(_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects);
    ...
    deleteListBtn.addEventListener('click', function(event) {
      event.stopPropagation();
      if (_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects.length > 0) {
        main.innerHTML = '';
        renderMainTitle(_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects[0].title);
        renderMainContainer();
        _log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.renderTasks(_log__WEBPACK_IMPORTED_MODULE_5__.initialTasks.myProjects[0].title);
      }
      deleteList(title);
      main.innerHTML = '';
      header.innerHTML = '';
    ...
    toDoBtn.addEventListener('click', function(event) {
      ...
      saveDescriptionBtn.addEventListener('click', function(event) {
        ...
        if (tempDueDate != undefined && tempDueDate != null && tempDueDate != '') {
          tempDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date(tempDueDate), "MM-dd-yyyy");
        }
        const currentDueDateBox = document.querySelector('#dueDateInput');
        const today = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date(), 'MM-dd-yyyy');
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(new Date(tempDueDate), new Date(today))) {
